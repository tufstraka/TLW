    ...
    <div className="landing-page">
      ...
      <div className="features">
        <div className="feature">
          <img src="/secure.svg" alt="Secure Transactions" className="feature-icon" />
        ...
        <div className="feature">
          <img src="/fast.svg" alt="Fast Transactions" className="feature-icon" />
        ...
        <div className="feature">
          <img src="/global.svg" alt="Global Reach" className="feature-icon" />
